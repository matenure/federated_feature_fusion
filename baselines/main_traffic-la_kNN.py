...
if __name__ == "__main__":
    ...
    if parser.local:
        ...
        model_name = "traffic-la_global_kNN_"
        ...
        synthesizer = Trainer(input_dim, no_event, no_series, workspace.nodes, hidden_dim=hidden_dim, lr=lr,
                              with_graph=True, permute=parser.permute, isGumbel=False, model_name=model_name, permute_reg=parser.reg, tau=tau)  # must use the same hidden dim as each node
